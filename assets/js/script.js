...
$("#contact-form").submit(function (event) {
    ...
    // Initialize EmailJS with your User ID (Public Key)
    emailjs.init("CpCjngaDzG283ZMmp");

    // Send the form data using the Service ID and Template ID
    emailjs.sendForm('service_d40sl1k', 'template_u8f4sok', '#contact-form')
...
document.addEventListener('visibilitychange',
    function () {
        if (document.visibilityState === "visible") {
            document.title = "Portfolio | Krisanth";
...
var typed = new Typed(".typing-text", {
    strings: ["Frontend Development", "Backend Development", "Web Development", "Data Analyst", "Full Stack Development"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
function showProjects(projects) {
    ...
    const srtop = ScrollReveal({
        origin: 'top',
        distance: '10px',  // Use a positive value for better visibility
        duration: 1000,
        reset: true
    });
